...
- [https://cssgradient.io/](https://cssgradient.io/) - My Personal Favourite
- [https://gradient-designer.csspost.com/](https://gradient-designer.csspost.com/)

## Image Resources

### Photos <Royalty Free Stock Images>

- [Pixabay](https://pixabay.com/)
- [Pexels](https://www.pexels.com)
- [Unsplash](https://unsplash.com/) - Unsplash has a very good api
...
- [Font Awesome](https://fontawesome.com/) - Popular One
- [Heroicons](https://heroicons.dev/)
- [Bootstrap Icons](https://icons.getbootstrap.com/) - Can use without Bootstrap
- [Simple Icons](https://simpleicons.org/)

### Illustrations

- [LottieFiles](https://lottiefiles.com/)
- [unDraw Illustrations](https://undraw.co/illustrations) - Limited Illustrations But very good
...
- [removebg](https://www.remove.bg/) - 100% Automatic & Free

## CSS

- [BEM Cheat Sheet](https://9elements.com/bem-cheat-sheet/) - BEM is a Naming Convention
...
- [tailwindcss](https://tailwindcss.com/) - Getting very Popular
- [tailwindcomponents](https://tailwindcomponents.com/)
- [Tailblocks](https://tailblocks.cc/) - Ready-to-use Tailwind CSS blocks
- [tailwindUI](https://tailwindui.com/components) - Tailwind UI Components
- [Tailwind Cheat-Sheet](https://nerdcave.com/tailwind-cheat-sheet) - Personal Favourite for Tailwind

### CSS Tools

- [flexbox](https://flexbox.io/)
- [CSS GRID](https://cssgrid.io/) - One of the good Grid Tools
...
- [98.css](https://jdan.github.io/98.css/) - Make website look like 90s
- [Enjoy CSS](https://enjoycss.com/) - Online CSS Code Generator
- [CSS Arrow Please](https://cssarrowplease.com/) - Arrows for Tool Tips
- [Image Effects with CSS](https://bennettfeely.com/image-effects/)

### CSS Animation

- [csseffects](https://emilkowalski.github.io/css-effects-snippets/) - Premade Effects
- [Keyframes](https://keyframes.app/) - Create Complex Animation
- [animista](https://animista.net/) - Gives Code on Demand
...
- [carbon](https://carbon.now.sh/) - Code Image Generator
- [codeimg](https://codeimg.io/) - Code Image Generator
...
- [HTML to Jade/Pug](http://www.html2jade.org/) - HTML to JADE/PUG
- [Base64 Converter](https://pr.gg/base64/) - One of the best thing you can find
...
- [CodePen](https://codepen.io) - Personal Favourite
- [JSFiddle](https://jsfiddle.net)
- [Liveweave](http://liveweave.com)
- [repl.it](https://repl.it)
- [JS Bin](https://jsbin.com/)
- [CodeSandbox](https://codesandbox.io/) - Popular One

## APIs

- [PrestoAPI](https://prestoapi.com/) - API Builder
- [JSON Placeholder](https://jsonplaceholder.typicode.com/)
- [OpenWeather](https://openweathermap.org/guide) - Open Weather API
- [The Star Wars API](https://swapi.dev/)
- [They Said So Quotes API](http://quotes.rest/)
- [Public API List](https://github.com/public-apis/public-apis) - Github Repo for API

## Developer Tools

- [Visual Studio Code](https://code.visualstudio.com/)
- [Postman](https://www.postman.com/) - API & REST Client <Popular>
...
- [snippet generator](https://snippet-generator.app/) - Snippets for VSCode, Sublime, ATOM
...
- [kite](https://www.kite.com/) - AI Coding Assistant [It works great]
...
- [React Developer Tools](https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi) - Must have for REACT
- [JSON Viewer](https://chrome.google.com/webstore/detail/json-viewer/gbmdgpbipfallnflgajpaliibnhdgobh)
- [WhatFont](https://chrome.google.com/webstore/detail/whatfont/jabopobgcpjmedljpbcaablpmlmfcogm?hl=en)
- [CSS Peeper](https://chrome.google.com/webstore/detail/css-peeper/mbnbehikldjhnfehhnaidhjhoofhpehk?hl=en) - Check CSS on Website
- [Dimensions](https://chrome.google.com/webstore/detail/dimensions/baocaagndhipibgklemoalmkljaimfdj) - Measure Screen Dimensions
- [Wireframe](https://chrome.google.com/webstore/detail/wireframe/amchfjeinhflcmbpdgdihhdoogdagcaf?hl=en-GB)
- [ColorZilla](https://chrome.google.com/webstore/detail/colorzilla/bhlhnicpbhignbdhedgjhgdocnmhomnp?ref=designrevision.com) - Great Color Picker
...
- [namecheap](https://www.namecheap.com/) - Cheap Domain Names
- [NameMesh](https://www.namemesh.com/) - Domain Name Generator/Suggestions
...
- [Lighthouse Metrics](https://lighthouse-metrics.com/) - Check Website Performance

## Project Management

- [Notion](https://www.notion.so/product)
- [Trello](https://trello.com/)
- [Coggle](https://coggle.it/) - Create Flowcharts
...
- [DevDocs](https://devdocs.io/) - Combine Every Docs in one Place
- [DevHints](https://devhints.io/) - Rico's Cheatsheet
...
- [Code with Ania Kub�w](https://www.youtube.com/channel/UC5DNytAJ6_FISueUfzZCVsw)
...
### Design & Front-End Youtube Channels
...
- [Cl�ment Mihailescu](https://www.youtube.com/channel/UCaO6VoaYJv4kS-TQO_M-N_g)
...
- [JavaScript 30](https://javascript30.com/) - Wes Bos Free <GREAT>
- [CSS GRID](https://cssgrid.io/) - Wes Bos <GREAT>
